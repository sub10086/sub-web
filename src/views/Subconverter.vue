  ...
  data() {
    return {
      ...
      options: {
        ...
        backendOptions: [{ value: "https://api.dingyue.gq/sub?" },{label: "站长自用",
                value:
                  "https://api2.dingyue.gq/sub?"
              },],
        remoteConfig: [
          {
            label: "universal",
            options: [
              ...
              },
              {
                label: "站长自用叁",
                value:
                  "https://raw.githubusercontent.com/flguize/zy/main/gz3.ini"
              },              
              {
                label: "站长自用肆",
                value:
                  "https://raw.githubusercontent.com/flguize/zy/main/gz4.ini"
              }, 
              {
                label: "站长自用肆杠叁",
                value:
                  "https://raw.githubusercontent.com/flguize/zy/main/gz4-3.ini"
              },
              {
                label: "站长自用肆杠肆",
                value:
                  "https://raw.githubusercontent.com/flguize/zy/main/gz4-4.ini"
              },
              {
                label: "站长自用肆杠柒",
                value:
                  "https://raw.githubusercontent.com/flguize/zy/main/gz4-7.ini"
              },                                                        
              {
                label: "No-Urltest",
                value:
    ...
    notify() {
      ...
      this.$notify({
        ...
        message: h(
          "i",
          { style: "color: teal" },
          "各种订阅链接（短链接服务除外）生成纯前端实现，无隐私问题。默认提供后端转换服务，不会储存任何数据，隐私担忧者请自行搭建后端服务。"
        )
      });
    },
    confirmUploadConfig() {
